...
public class ConfigReader {
    public static Properties properties; // Yapılandırma verilerini saklamak için Properties nesnesi oluşturuluyor.

    static {
        String filePath = "src/test/resources/config.properties"; // Yapılandırma dosyasının yolu belirleniyor.
        try {
